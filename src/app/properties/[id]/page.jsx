...
import { IoHomeOutline, IoBedOutline, IoCheckmarkCircleOutline, IoBrushOutline, IoSquareOutline } from 'react-icons/io5'

import { estate_lit, estate_living_room, estate_lawn, estate_reading_table } from '@/assets/images'
            ...
            <section className="relative py-10 bg-white px-4">
                <div className="relative max-w-screen-lg mx-auto w-full grid grid-cols-[1.5fr_.5fr_1fr_1fr] gap-3 grid-flow-dense">
                    <div className="col-span-3 sm:col-span-2 md:col-span-1 py-5 flex flex-col gap-3 justify-center">
                        <h2 className="w-full max-w-lg mx-auto text-2xl sm:text-3xl md:text-4xl font-semibold text-slate-700">Find the <span className="text-indigo-600">Best Places</span> Near You.</h2>
                    ...
                    <form className="grid place-items-center rounded-md overflow-hidden relative h-[160px] sm:h-[200px] md:h-[250px] group">
